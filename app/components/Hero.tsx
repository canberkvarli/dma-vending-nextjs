      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="flex flex-col items-center text-center">
          ...
          <motion.h1
            ...
            className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-12 leading-tight max-w-4xl"
          >
          ...
          <motion.p
            ...
            className="text-xl md:text-2xl font-semibold text-primary mb-8 max-w-3xl"
          >
          ...
          <motion.p
            ...
            className="text-lg md:text-xl text-white/90 mb-12 leading-relaxed max-w-4xl"
          >
            Are you tired of junk food-only vending machines? Do you want to offer healthy, natural or low-calorie food and beverage options? HealthyChoice helps you provide the healthy options you want while helping you promote a healthy lifestyle for your gym, school, facility, or location. All without any cost or long-term commitment to you.
          </motion.p>
